<div class="login-container col-md-4 col-md-offset-4" id="login-form">
    ...
    <div class="link-action text-center">
        <div class="col-sm-6 col-xs-12">
            <a href="authentication/fg_password" style="display:inline-block; margin-top: 5px;" class="fg-passw"></a>
        </div>
        <div class="col-sm-6 col-xs-12">
            <a href="authentication/register" style="display:inline-block; margin-top: 5px;" class="register"></a>
        </div>
