                ...
                <div class="cus-body">
                    ...
                    <div class="alert alert-info summany-info clearfix" role="alert">
                        <div class="ajax-loadlist-total sm-info pull-left padd-0">
                            <span><b><?php echo (isset($_total_customer) && !empty($_total_customer)) ? $_total_customer : ''; ?></b></span>
                               <span><b><?php echo (isset($_total_money) && !empty($_total_money)) ? cms_encode_currency_format($_total_money) : ''; ?></b> </span>   <span><b><?php echo (isset($_total_debt) && !empty($_total_debt)) ? cms_encode_currency_format($_total_debt) : ''; ?></b> </span></div>
