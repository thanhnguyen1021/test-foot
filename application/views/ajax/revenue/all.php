<div class="quick-info report row" style="margin-bottom: 30px;">
            ...
            <div class="report-box" style="border: 1px dotted #ddd; border-radius: 0">
                ...
                <div class="infobox-data">
                    <h3 class="infobox-title cgreen"
                        style="font-size: 30px;"><?php echo (isset($total_orders['quantity'])) ? $total_orders['quantity'] : 0; ?> / <?php echo (isset($total_orders['total_quantity'])) ? $total_orders['total_quantity'] : 0; ?></h3>
                    <span class="infobox-data-number text-center" style="font-size: 20px; color: #555;">Số đơn / Số lượng SP</span>
                </div>
            </div>
        </div>
            ...
            <div class="report-box " style="border: 1px dotted #ddd; border-radius: 0">
                ...
                <div class="infobox-data">
                    <h3 class="infobox-title orange"
                        style="font-size: 30px;"><?php echo cms_encode_currency_format((isset($total_orders['total_money']) ? $total_orders['total_money'] : 0)); ?></h3>
                    <span class="infobox-data-number text-center"
                          style="font-size: 20px; color: #555;">Doanh thu</span>
                </div>
            </div>
        </div>
